...
def _load_cases():
    path = Path(__file__).with_name("_freezer_test_cases.py")
    spec = importlib.util.spec_from_file_location("_rts_freezer_test_cases", path)
...
class FreezerTests(_CASES.FreezerTests):
